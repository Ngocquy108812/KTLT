...
public class Buoi4 {
    public static void bai4_1() {
        ...
        System.out.print("\nDanh sách các phần tử của mảng arr là: ");
    ...
    public static void bai4_2() {
        ...
        System.out.print("\nDanh sách các phần tử của ngũ hành là; ");
    ...
    {
        System.out.printf("\nDanh sách các phần tử lẻ hoặc nhỏ hơn n = %d là: ", n);
        for (int i = 1; i <= n; i++)
        { 
            if(i%2!=0)
            {
    ...
    public static void bai4_3()
    {
        ...
        System.out.println("\nDanh sach cac phan tu cua mang arr1 la: ");
